...
export const CAPABILITIES = [
  ...
  { id: "backend-cloud", icon: CloudQueue, title: "Backend, AWS & Infrastructure", blurb: "Microservices in Go with AWS Lambda, DynamoDB, and Terraform IaC — event-driven, tested, and reliable."},
  { id: "instructional-design", icon: School, title: "Instructional Design & eLearning", blurb: "Designs engaging, learner-centered digital content grounded in pedagogy and user experience. Combines classroom expertise with data-driven curriculum development, writing clarity, and modern eLearning tools to improve comprehension and outcomes."}
];
